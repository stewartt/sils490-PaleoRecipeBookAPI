...
var USER_OR_GROUP_NAME = 'tanastewart'; // TODO: Insert GitHub username or group name.
...
////////////////////////////////////////////////////////////////////////////////
app.put('/recipe/:id',      // TODO: change to suit your URI design.
  function(req, res) {
    ...
    item.type = 'recipe'; // TODO: change to the type of item you want
...
////////////////////////////////////////////////////////////////////////////////
app.get('/recipe/',         // TODO: change to suit your URI design. 
  function(req, res) {

    var item_type = 'recipe'; // TODO: change to the type of item you want.
...
////////////////////////////////////////////////////////////////////////////////
app.post('/ingredient/', // TODO: change to suit your URI design.
  function(req, res) {
    ...
    item.type = 'ingredient'; // TODO: change to the type of item you want
...
////////////////////////////////////////////////////////////////////////////////
app.put('/ingredient/:id', // TODO: change to suit your URI design.
  function(req, res) {
...
////////////////////////////////////////////////////////////////////////////////
app.get('/ingredient/',          // TODO: change to suit your URI design. 
  function(req, res) {

    var item_type = 'ingredient'; // TODO: change to the type of item you want.
    ...
    db.getSome(item_type, req.query, function(err, items) {
      ...
      // Otherwise, use the returned data to render an HTML page.
        ...
        res.render(
          'list-ingredients', // TODO: change to the name of your HTML template.
          { items: items }
        );
      }
    });
...
////////////////////////////////////////////////////////////////////////////////
app.get('/recipe/:id',      // TODO: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the related items associated with this item.
        ...
        var related_type = 'ingredient'; // TODO: change to type of related item.

        // Set our query to find the items related to the requested item.
        req.query.ingredient = item_id; // TODO: change `party` to reflect the
        ...
        db.getSome(related_type, req.query, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
            'one-recipe', // TODO: change to the name of your HTML template.
...
////////////////////////////////////////////////////////////////////////////////
app.get('/ingredient/:id',       // TODO: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the items potentially related to this item.
        ...
        var same_type = 'ingredient'; // TODO: change to type of related item.

        // Get all items of the specified related type.
        db.getAll(same_type, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
              'one-ingredient', // TODO: change to name of your HTML template.
              { item: item, same_items: items }
            );
          }
        });
      }
